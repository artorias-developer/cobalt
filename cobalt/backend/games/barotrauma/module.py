...
from games.barotrauma.vanilla.application.services import VanillaServersService
from games.barotrauma.vanilla.infrastructure import VanillaLoader


class BarotraumaGameModule(AbstractGameModule):
    """
    Barotrauma game module.
    """
