...
class VanillaServersService(AbstractServersService):
    """
    Barotrauma Vanilla servers service.
    """
    _INTERNAL_PORT = 27015
    _STEAM_APP_ID = 1026340
    _INSTALLATION_MARKER = "DedicatedServer"
    ...
    async def create(
        ...
        - download_link: Download link for Vanilla Barotrauma.
