...
class VanillaLoader(AbstractLoader):
    ...
    async def get_download_link(
        ...
        """
        Barotrauma Dedicated Server is distributed exclusively via SteamCMD (App ID 1026340). There are no
        ...
        """
        raise NotImplementedError(f"Barotrauma does not support direct download links")
