...
from games.dont_starve_together.vanilla.application.services import VanillaServersService
from games.dont_starve_together.vanilla.infrastructure import VanillaLoader


class DontStarveTogetherGameModule(AbstractGameModule):
    """
    Don't Starve Together game module.
    """
