...
import { LOCALE_HELPER_KEY, HTTP_METRICS_API_SERVICE_KEY, WS_METRICS_API_SERVICE_KEY } from "@/constants"
...
const chartRef = ref<InstanceType<typeof ChartLine> | null>(null)
