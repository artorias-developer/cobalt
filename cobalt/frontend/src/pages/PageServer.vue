...
import ProjectZomboidPageServer from "@/pages/games/project-zomboid/PageServer.vue"
import RimWorldPageServer from "@/pages/games/rim-world/PageServer.vue"
import SevenDaysToDiePageServer from "@/pages/games/seven-days-to-die/PageServer.vue"
...
const gameComponents: Record<string, Component> = {
  ...
  project_zomboid: ProjectZomboidPageServer,
  rim_world: RimWorldPageServer,
  seven_days_to_die: SevenDaysToDiePageServer,
  terraria: TerrariaPageServer
}
